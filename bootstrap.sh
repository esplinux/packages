...
espbuild -D BOOTSTRAP linuxHeaders.esp cacert.esp musl.esp compilerRT.esp libunwind.esp libcxx.esp dash.esp awk.esp make.esp curl.esp toybox.esp llvm.esp clang.esp lld.esp cmake.esp
